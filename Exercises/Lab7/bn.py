...
def sprinkler(): # PROB EDIT THIS
    ...
    sprinkler = Variable('Sprinkler', ('false', 'true'), t2, [cloudy]) # cloudy is parent
    ...
    joint_values = { # insert values here
        'Sprinkler': 'false',
        'Cloudy': 'false',
        'WetGrass': 'false',
        'Rain': 'true'
    ...
    conditionals_vars = {'Sprinkler': 'true'} # conditionals vars P(vars | evidents) vars given evidents, evidents are condition
    conditionals_evidents = {'WetGrass': 'true'} # evidents
